...
namespace GesturBee_Backend.Migrations
{
    ...
    [Migration("20250527130349_UpdateExerciseItemSchema")]
    partial class UpdateExerciseItemSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GesturBee_Backend.Models.Video", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GesturBee_Backend.Models.Video", b =>
                {
                    b.HasOne("GesturBee_Backend.Models.ExerciseItem", "ExerciseItem")
                        .WithOne("Video")
                        .HasForeignKey("GesturBee_Backend.Models.Video", "ExerciseItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
